    ...
    <section className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-[#0f2b3d] via-[#1a3a4f] to-[#0f2b3d]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-8">
        ...
        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight">
          Grow <span className="italic font-light text-gray-300">With</span><br />
          Expert Guidance
        </h2>

        {/* Description */}
        <p className="text-gray-300 text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed">
          Unlock new opportunities and scale your business with tailored strategies 
          designed for growth. Our expert guidance helps you overcome challenges, 
          optimize operations, and achieve lasting success.
        </p>

        {/* CTA Button */}
        <div className="pt-4">
          <button className="group inline-flex items-center space-x-3 px-6 py-3 bg-[#F5A623] text-[#0f2b3d] font-bold text-lg rounded-full hover:bg-[#ffb340] hover:shadow-2xl hover:shadow-[#F5A623]/30 hover:scale-105 transition-all duration-300">
